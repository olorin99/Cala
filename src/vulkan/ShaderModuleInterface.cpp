...
auto typeToMemberType(const spirv_cross::SPIRType& type) {
    switch (type.basetype) {
        case spirv_cross::SPIRType::BaseType::Struct:
            return cala::vk::ShaderModuleInterface::MemberType::STRUCT;
        case spirv_cross::SPIRType::Unknown:
            break;
        case spirv_cross::SPIRType::Void:
            break;
        case spirv_cross::SPIRType::Boolean:
            return cala::vk::ShaderModuleInterface::MemberType::BOOL;
        ...
        case spirv_cross::SPIRType::Int:
            return cala::vk::ShaderModuleInterface::MemberType::INT;
        case spirv_cross::SPIRType::UInt:
            return cala::vk::ShaderModuleInterface::MemberType::UINT;
        ...
        case spirv_cross::SPIRType::Float:
            return cala::vk::ShaderModuleInterface::MemberType::FLOAT;
...
std::vector<cala::vk::ShaderModuleInterface::Member> getStructMembers(const spirv_cross::SPIRType& type, spirv_cross::Compiler& compiler) {
    std::vector<cala::vk::ShaderModuleInterface::Member> members;
...
cala::vk::ShaderModuleInterface::ShaderModuleInterface(std::span<u32> spirv, cala::vk::ShaderStage stage)
    : _stage(stage)
{
    if (spirv.empty())
        return;
