...
cala::vk::ShaderInterface::ShaderInterface(std::span<vk::ShaderModuleInterface> moduleInterfaces) {
...
cala::vk::ShaderInterface::~ShaderInterface() {
//    for (auto& set : sets) {
...
bool cala::vk::ShaderInterface::bindingHasMember(u32 set, u32 binding, const std::string& memberName) const {
...
cala::vk::ShaderModuleInterface::Member cala::vk::ShaderInterface::getBindingMember(u32 set, u32 binding, const std::string& memberName) const {
    auto& b = sets[set].bindings[binding];
    auto it = b.members.find(memberName);
    if (it != b.members.end()) {
        return it->second;
...
std::vector<cala::vk::ShaderModuleInterface::Member> cala::vk::ShaderInterface::getBindingMemberList(u32 set, u32 binding) const {
