...
cala::vk::Framebuffer::Framebuffer(VkDevice device, RenderPass &renderPass, std::span<VkImageView> attachments, u32 width, u32 height)
    : _device(device),
...
cala::vk::Framebuffer::Framebuffer(VkDevice device, RenderPass &renderPass, MaterialInstance *instance, u32 width, u32 height)
    : _device(device),
    _framebuffer(VK_NULL_HANDLE),
    _renderPass(renderPass),
    _width(width),
...
cala::vk::Framebuffer::~Framebuffer() {
