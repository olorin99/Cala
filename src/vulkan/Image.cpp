...
cala::vk::Image::Image(cala::vk::Device *device)
    : _device(device),
...
cala::vk::Image::Image(Image &&rhs) noexcept
    : _device(rhs._device),
      _image(VK_NULL_HANDLE),
      _allocation(nullptr),
      _width(0),
...
cala::vk::Image &cala::vk::Image::operator=(Image &&rhs) noexcept {
...
cala::vk::Image::View::View(View &&rhs) noexcept
    : _device(VK_NULL_HANDLE),
    view(VK_NULL_HANDLE),
    _image(nullptr)
{
...
cala::vk::Image::View &cala::vk::Image::View::operator=(View &&rhs) noexcept {
    std::swap(_device, rhs._device);
    std::swap(view, rhs.view);
    std::swap(_image, rhs._image);
    return *this;
...
void cala::vk::Image::_data(cala::vk::Device& driver, DataInfo info, std::span<u8> data) {
...
void *cala::vk::Image::map(u32 format) {
    void* address = nullptr;
    vmaMapMemory(_device->context().allocator(), _allocation, &address);
    return address;
}

void cala::vk::Image::unmap() {
    vmaUnmapMemory(_device->context().allocator(), _allocation);
}

void cala::vk::Image::blit(CommandHandle buffer, Image &dst, ImageLayout srcLayout, ImageLayout dstLayout, VkFilter filter) {
...
void cala::vk::Image::copy(cala::vk::CommandHandle buffer, cala::vk::Image &dst, u32 srcLayer, u32 dstLayer, u32 srcMipLevel, u32 dstMipLevel) {
...
void cala::vk::Image::copy(cala::vk::CommandHandle buffer, cala::vk::Buffer &dst, u32 dstOffset, u32 srcLayer, u32 srcMipLevel) {
...
void cala::vk::Image::generateMips() {
...
void cala::vk::Image::generateMips(CommandHandle cmd) {
    // mip -> mip+1
...
cala::vk::Image::View cala::vk::Image::newView(u32 mipLevel, u32 levelCount, u32 arrayLayer, u32 layerCount, cala::vk::ImageViewType viewType, Format format) {
...
//VkImageMemoryBarrier cala::vk::Image::barrier(Access srcAccess, Access dstAccess, ImageLayout srcLayout, ImageLayout dstLayout, u32 layer) {
//    VkImageSubresourceRange range{};
//    range.aspectMask = isDepthFormat(_format) ? VK_IMAGE_ASPECT_DEPTH_BIT : VK_IMAGE_ASPECT_COLOR_BIT;
//    range.baseMipLevel = 0;
...
cala::vk::Image::Barrier cala::vk::Image::barrier(PipelineStage srcStage, PipelineStage dstStage, Access srcAccess, Access dstAccess, ImageLayout dstLayout, u32 layer) {
    Barrier b{};
...
cala::vk::Image::Barrier cala::vk::Image::barrier(PipelineStage srcStage, PipelineStage dstStage, Access srcAccess, Access dstAccess, ImageLayout srcLayout, ImageLayout dstLayout, u32 layer) {
    Barrier b{};
    b.subresourceRange.aspectMask = isDepthFormat(_format) ? VK_IMAGE_ASPECT_DEPTH_BIT : VK_IMAGE_ASPECT_COLOR_BIT;
    b.subresourceRange.baseMipLevel = 0;
    b.subresourceRange.levelCount = VK_REMAINING_MIP_LEVELS;
...
void cala::vk::Image::setLayout(VkImageLayout layout) {
